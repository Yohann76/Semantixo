/**
 * Classe AnalyzerTextSeo pour l'analyse SEO de textes
 */
class AnalyzerTextSeo {
  /**
  ...
  static async analyze(text) {
    try {
      ...
      console.error('Erreur AnalyzerTextSeo.analyze:', error);
      throw new Error('Erreur lors de l\'analyse SEO du texte');
    }
  }
}

module.exports = AnalyzerTextSeo; 